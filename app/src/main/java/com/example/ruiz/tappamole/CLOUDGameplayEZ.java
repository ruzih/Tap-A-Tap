...
public class CLOUDGameplayEZ extends AppCompatActivity {

    Random r = new Random();
    int randomMole;
    public static int POINTS7 = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cloudmode_gameplay_ez);
                            ...
                            if (randomMole == 1) {
                                ...
                                mole1.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        pointCount.setText("" + String.format("%03d", POINTS7));
                                        mole1.setVisibility(View.INVISIBLE);
                                    }
                                });
        ...
        handle2.postDelayed(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(CLOUDGameplayEZ.this, "GAME OVER", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(), CLOUDPlayAgainEZ.class);
